<template>
  ...
  <q-page>
    ...
    <div class="row q-col-gutter-md">
      ...
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <q-card>
          <q-card-section>
            ...
            <q-list
              separator
              class="scroll_questions_list scroll"
              ...
              >
                <q-item-section avatar>
                  <q-icon
                    name="account_circle"
                    size="50px"
                    class="content_questions_icons"
                  />
                </q-item-section>
                <q-item-section>
                  <q-item-label class="text-h4">{{ item.title }}</q-item-label>
                  <q-item-label caption class="text-h5">{{
                    item.time
                  }}</q-item-label>
                </q-item-section>
              </q-item>
      ...
      <div
        class="col-lg-4 col-md-4 col-sm-12 col-xs-12 row q-col-gutter-md q-mx-none q-px-none"
      >
        <!-- Секция 2 -->
        ...
        <q-card>
          <q-card-section>
            ...
            <q-list
              dense
              separator
              class="scroll_devices_list scroll"
